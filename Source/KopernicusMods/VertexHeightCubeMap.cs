...
namespace AdvancedPQSTools
{
    ...
    public class VertexHeightCubeMap : ModLoader<PQSMod_VertexHeightCubeMap>
    {
        ...
        [ParserTarget("mapXn")]
        public MapSOParserHeightAlpha<MapSOTile> vertexHeightMapXn
        {
            get { return Mod.vertexHeightMapXn; }
            set { Mod.vertexHeightMapXn = value; }
        }
        [ParserTarget("mapXp")]
        public MapSOParserHeightAlpha<MapSOTile> vertexHeightMapXp
        {
            get { return Mod.vertexHeightMapXp; }
            set { Mod.vertexHeightMapXp = value; }
        }
        [ParserTarget("mapYn")]
        public MapSOParserHeightAlpha<MapSOTile> vertexHeightMapYn
        {
            get { return Mod.vertexHeightMapYn; }
            set { Mod.vertexHeightMapYn = value; }
        }
        [ParserTarget("mapYp")]
        public MapSOParserHeightAlpha<MapSOTile> vertexHeightMapYp
        {
            get { return Mod.vertexHeightMapYp; }
            set { Mod.vertexHeightMapYp = value; }
        }
        [ParserTarget("mapZn")]
        public MapSOParserHeightAlpha<MapSOTile> vertexHeightMapZn
        {
            get { return Mod.vertexHeightMapZn; }
            set { Mod.vertexHeightMapZn = value; }
        }
        [ParserTarget("mapZp")]
        public MapSOParserHeightAlpha<MapSOTile> vertexHeightMapZp
        {
