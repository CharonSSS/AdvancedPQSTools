...
namespace AdvancedPQSTools
{
    ...
    public class RunwayFix : MonoBehaviour
    {
        ...
        public static RunwayFix Instance { get; private set; } = null;
        ...
        public void Start()
        {
            foreach (ConfigNode n in GameDatabase.Instance.GetConfigNodes("RUNWAYFIX"))
            {
        ...
        internal void PrintDebug(string message)
        {
            ...
            Debug.Log($"[AdvancedPQSTools] {caller}:{line}: {message}");
        }
